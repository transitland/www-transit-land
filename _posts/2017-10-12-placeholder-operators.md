...
If you do know the GTFS feed, [submit it to the Feed Registry here](https://transit.land/feed-registry/feeds/new). And if you're a transit operator that cannot host your own GTFS feed, we can host it for you - [email us](mailto:transitland@mapzen.com). 
